                  ...
                  <div id="collapseOne" class="collapse multi-collapse show" aria-labelledby="headingOne"
                      ...
                      <div class="card-body">
                          <div class="row">
                              <div class="col">
                                  <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" name="nomeDisciplina"
                                             id="nomeDisciplina" placeholder="Nome da Disciplina:" required>
                                  </div>
                              </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    <label for="matricula">Carga Horária da Disciplina (Em horas):</label>
                                    <input type="number" class="form-control" name="cargaHorariaDisciplina"
                                           id="cargaHorariaDisciplina" placeholder="Carga Horária da Disciplina:" min="0"required>
                                </div>
                            </div>
                        </div>
